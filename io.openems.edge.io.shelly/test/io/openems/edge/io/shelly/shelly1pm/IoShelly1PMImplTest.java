...
public class IoShelly1PMImplTest {

	@Test
	public void test() throws Exception {
		final var sut = new IoShelly1PmImpl();
		...
		new ComponentTest(sut) //
				...
				.next(new TestCase("Successful read response") //
						...
						.output(IoShelly1Pm.ChannelId.RELAY, null) // expecting WriteValue
						.output(IoShelly1Pm.ChannelId.SLAVE_COMMUNICATION_FAILED, false)) //
				...
				.next(new TestCase("Invalid read response") //
						...
						.output(IoShelly1PM.ChannelId.RELAY, null) // expecting WriteValue
						.output(IoShelly1PM.ChannelId.SLAVE_COMMUNICATION_FAILED, true)) //
